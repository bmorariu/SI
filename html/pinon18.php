...
if(!$_SESSION["loggedIn"])
	...
	if($_GET['value'] == 1){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 2");
	}
	if($_GET['value'] == 2){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 4");
	}
	if($_GET['value'] == 3){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 8");
	}
	if($_GET['value'] == 4){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 16");
	}
	if($_GET['value'] == 5){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 32");
	}
	if($_GET['value'] == 6){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 64");
	}
	if($_GET['value'] == 7){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 128");
	}
	if($_GET['value'] == 8){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 256");
	}
	if($_GET['value'] == 9){
		system("gpio -g mode 18 pwm");
		system("gpio -g pwm 18 512");
	}
	if($_GET['value'] == 10){
		system("gpio -g mode 18 pwm");
...
<html>
	...
	<body>
		...
		<div id="nr12" onclick="location.href='pinoff18.php';"><img src="green.png" height="30px" width="30px"></div>
